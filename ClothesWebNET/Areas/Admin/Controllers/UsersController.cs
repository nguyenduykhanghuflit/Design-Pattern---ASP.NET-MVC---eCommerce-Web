...
namespace ClothesWebNET.Areas.Admin.Controllers
{
    public class UsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idUser,idPermission,fullName,username,password,gender,identityCard,address,email,URLAvatar,phone")] Users user)
        {
            if (Session["SESSION_GROUP_ADMIN"] != null)
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idUser,idPermission,username,fullName,password,gender,identityCard,address,email,URLAvatar,phone")] Users user)
        {
            if (Session["SESSION_GROUP_ADMIN"] != null)
            {
                if (ModelState.IsValid)
