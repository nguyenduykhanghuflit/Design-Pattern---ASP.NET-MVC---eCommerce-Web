...
namespace ClothesWebNET.Areas.Admin.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "nameProduct,idProduct,sizeM,sizeL,sizeXL,size38,size39,size40,size41,size42,price,description,idType")] Product product, HttpPostedFileBase img1, HttpPostedFileBase img2)
        {
            if (Session["SESSION_GROUP_ADMIN"] != null)
            {
